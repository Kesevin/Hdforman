...
public class ImageCompressUtil {
    private static final String TAG = ImageCompressUtil.class.getName();

    public static final int FIRST_GEAR = 1;
    public static final int THIRD_GEAR = 3;
    public static String DEFAULT_DISK_CACHE_DIR = GlobalConfig.IMAGE_CACHE;
    ...
    private ImageCompressUtil(Context context) {
        mCacheDir = ImageCompressUtil.getPhotoCacheDir(context);
        executor = new AsyncExecutor();
    }

    public static ImageCompressUtil from(Context context) {
    ...
    public static File getPhotoCacheDir(Context context) {
        return getPhotoCacheDir(context, ImageCompressUtil.DEFAULT_DISK_CACHE_DIR);
    }
    ...
    public ImageCompressUtil load(File file) {
        mFile = file;
        return this;
    }

    public ImageCompressUtil load(String path) {
        mFile = new File(path);
        return this;
    }

    public ImageCompressUtil putGear(int gear) {
        this.gear = gear;
        return this;
    }
