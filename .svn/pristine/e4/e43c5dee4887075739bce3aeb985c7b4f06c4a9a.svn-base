...
public class WaitSignItemModel extends EpoxyModelWithHolder<WaitSignItemModel.WaitSignItemHolder> {
    @EpoxyAttribute
    ...
    @Override
    public void bind(WaitSignItemHolder holder) {
        super.bind(holder);
    ...
    @Override
    protected WaitSignItemHolder createNewHolder() {
        return new WaitSignItemHolder();
    }
    ...
    static class WaitSignItemHolder extends BaseEpoxyHolder {
