...
@ActivityScope
@Component(modules = WaitForPaymentModule.class, dependencies = AppComponent.class)
public interface WaitForPaymentComponent {
    void inject(WaitForPaymentActivity activity);
}