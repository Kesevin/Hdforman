package com.dgg.hdforeman.mvp.model.api.cache;
...
public interface CommonCache {
      ...
      Observable<List<UppacInfo>> getUppackageInfo(Observable<List<UppacInfo>> listObservable, DynamicKey dynamicKey, EvictDynamicKey evictDynamicKey);
