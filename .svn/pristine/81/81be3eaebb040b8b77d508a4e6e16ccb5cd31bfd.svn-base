...
public class CharactorHandler {
    public static String PHONE_REGULAR = "^1[3-8]\\d{9}$";
    ...
    public static boolean isPhone(String phone) {
        if (TextUtils.isEmpty(phone) || !phone.matches(PHONE_REGULAR))
            return false;
    ...
    public static String excludeEmptyWithZero(String str) {
        if (TextUtils.isEmpty(str) || str.equals("null"))
            return "0";
