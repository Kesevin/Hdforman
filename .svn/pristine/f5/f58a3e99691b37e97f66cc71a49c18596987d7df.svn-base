...
@ActivityScope
@Component(modules = MaterialBagModule.class, dependencies = AppComponent.class)
public interface MaterialBagComponent {
    void inject(MaterialBagFragment fragment);
}