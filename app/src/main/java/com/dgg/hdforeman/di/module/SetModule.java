...
import com.dgg.hdforeman.mvp.model.mine.SetModel;
...
public class SetModule {
    ...
    @ActivityScope
    @Provides
    SetContract.Model provideSetModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new SetModel(serviceManager, cacheManager, gson, application);
    }
}