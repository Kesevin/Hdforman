...
@ActivityScope
@Component(modules = WithdrawsCashModule.class, dependencies = AppComponent.class)
public interface WithdrawsCashComponent {
    void inject(WithdrawsCashActivity activity);
}