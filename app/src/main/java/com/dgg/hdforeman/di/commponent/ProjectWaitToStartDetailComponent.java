...
@ActivityScope
@Component(modules = ProjectWaitToStartDetailModule.class, dependencies = AppComponent.class)
public interface ProjectWaitToStartDetailComponent {
    void inject(ProjectWaitToStartDetailActivity activity);
}