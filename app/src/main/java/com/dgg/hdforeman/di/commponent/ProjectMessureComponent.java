...
@ActivityScope
@Component(modules = ProjectMessureModule.class, dependencies = AppComponent.class)
public interface ProjectMessureComponent {
    void inject(ProjectMessureActivity activity);
}
