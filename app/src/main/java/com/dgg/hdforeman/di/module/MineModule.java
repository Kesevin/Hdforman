...
import com.dgg.hdforeman.mvp.model.mine.MineModel;
...
public class MineModule {
    ...
    @ActivityScope
    @Provides
    MineContract.Model provideMineModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new MineModel(serviceManager, cacheManager, gson, application);
    }
}