...
public class MineModel extends BaseModel<ServiceManager, CacheManager> implements MineContract.Model {
    ...
    @Override
    public Observable<BaseData<MineBean>> getMyScore() {
        return mCommonService.getMyScore(ApiUtil.getParams(Api.RequestModule.getMyScore.getClassName(),Api.RequestModule.getMyScore.getMethodName(),new JSONObject()));
    }
}