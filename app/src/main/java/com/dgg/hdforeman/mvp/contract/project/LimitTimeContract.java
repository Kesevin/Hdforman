...
public interface LimitTimeContract {
    ...
    interface Model {
        Observable<BaseData<BudgetSheetBean>> getBudgetSheetData(String proid, String date);
        Observable<BaseData<String>> sendToCustomer(@Nullable String pcs_proid);
    }
}